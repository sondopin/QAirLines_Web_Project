  ...
  return (
    <footer className="flex flex-col px-28 py-12 bg-slate-700 max-md:px-5">
      <div className="flex flex-wrap gap-20 items-start w-full text-white max-md:max-w-full">
        <section className="flex flex-col text-xs font-medium min-w-[150px] w-[250px]">
          <div className="flex flex-col max-w-full w-[150px]">
            <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/a3603a43a6741f0b32be76937b4e6bd5b92a11c2a04469c48351cadb5d030c82?placeholderIfAbsent=true&apiKey=cdf4ef6bf30f4b36bc29a527c8e3e010" alt="Lift Media Logo" className="object-contain aspect-[1.68] w-[84px]" />
          ...
          <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/25c8d60067fc0f313fa8f668b89ecc61a56f5be4b3e2f574bb1a02283343722e?placeholderIfAbsent=true&apiKey=cdf4ef6bf30f4b36bc29a527c8e3e010" alt="Social Media Icons" className="object-contain mt-10 max-w-full aspect-[3.86] w-[135px]" />
        </section>
          ...
          <div className="flex flex-col justify-center px-9 py-10 rounded-3xl bg-white bg-opacity-10 max-md:px-5">
            <div className="flex flex-col">
              <div className="flex flex-col max-w-full text-base font-bold leading-7 whitespace-nowrap w-[248px]">
                <h3>Subscribe</h3>
                <form>
                  <label htmlFor="subscribe-email" className="sr-only">Subscribe to our newsletter</label>
                  <input
                    type="email"
                    id="subscribe-email"
      ...
      <nav className="flex flex-wrap gap-8 justify-center items-center mt-11 w-full text-sm text-center text-white whitespace-nowrap max-md:mt-10 max-md:max-w-full">
        <a href="#terms" className="self-stretch my-auto hover:opacity-75 transition-opacity">Terms</a>
        <a href="#privacy" className="self-stretch my-auto hover:opacity-75 transition-opacity">Privacy</a>
        <a href="#cookies" className="self-stretch my-auto hover:opacity-75 transition-opacity">Cookies</a>
      </nav>
    </footer>
  );
};
